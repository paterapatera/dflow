...
| userTypeId         | string             | ユーザー種類への参照     | 必須         |
| userEnvironmentIds | array<int, string> | ユーザー環境への参照     | 必須         |
| userStatusIds      | array<int, string> | ユーザー利用状況への参照 | 必須         |
| usageFrequency     | string             | 利用頻度                 | 必須         |
| userDeviceIds      | array<int, string> | ユーザー利用端末への参照 | 必須         |
